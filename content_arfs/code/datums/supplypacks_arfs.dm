/datum/supply_pack/misc/blueshieldgear
	...
	contains = list(
			...
			/obj/item/clothing/under/blueshield = 1,
			/obj/item/clothing/under/blueshield2 = 1,
			/obj/item/clothing/suit/armor/blueshield = 1,
			/obj/item/clothing/suit/armor/blueshieldcoat = 1,
