...
//
//	All sorts of balls go here!
*/

/obj/item/toy/tennis
	name = "classic tennis ball"
	desc = "A classic tennis ball. It appears to have faint bite marks scattered all over its surface."
	icon = 'content_arfs/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	item_icons = list(
		slot_l_hand_str = 'content_arfs/icons/mob/inhands/balls_left.dmi',
		slot_r_hand_str = 'content_arfs/icons/mob/inhands/balls_right.dmi',
		slot_wear_mask_str = 'content_arfs/icons/mob/mouthball.dmi'
		)
