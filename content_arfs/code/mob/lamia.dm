/mob/living/simple_mob/vore/lamia/arfs
	vore_tail_digest_chance = 0

/mob/living/simple_mob/vore/lamia/arfs/andy
...
// Albino
/mob/living/simple_mob/vore/lamia/arfs/albino
	name = "albino lamia"
...
/mob/living/simple_mob/vore/lamia/arfs/albino/bra
...
/mob/living/simple_mob/vore/lamia/arfs/albino/shirt
...
// Cobra
/mob/living/simple_mob/vore/lamia/arfs/cobra
	name = "cobra lamia"
...
/mob/living/simple_mob/vore/lamia/arfs/cobra/bra
...
/mob/living/simple_mob/vore/lamia/arfs/cobra/shirt
...
// Copper
/mob/living/simple_mob/vore/lamia/arfs/copper
	name = "copper lamia"
...
/mob/living/simple_mob/vore/lamia/arfs/copper/bra
...
/mob/living/simple_mob/vore/lamia/arfs/copper/shirt
...
// Green
/mob/living/simple_mob/vore/lamia/arfs/green
	name = "green lamia"
...
/mob/living/simple_mob/vore/lamia/arfs/green/bra
...
/mob/living/simple_mob/vore/lamia/arfs/green/shirt
...
// Zebra
/mob/living/simple_mob/vore/lamia/arfs/zebra
	name = "zebra lamia"
...
/mob/living/simple_mob/vore/lamia/arfs/zebra/bra
...
/mob/living/simple_mob/vore/lamia/arfs/zebra/shirt
...
GLOBAL_LIST_INIT(valid_random_lamias_arfs, list(
	/mob/living/simple_mob/vore/lamia/arfs,
	/mob/living/simple_mob/vore/lamia/arfs/bra,
	/mob/living/simple_mob/vore/lamia/arfs/albino,
	/mob/living/simple_mob/vore/lamia/arfs/albino/bra,
...
/mob/living/simple_mob/vore/lamia/random/arfs
/mob/living/simple_mob/vore/lamia/random/arfs/New()
	var/mob/living/simple_mob/vore/lamia/arfs/new_attrs = pick(GLOB.valid_random_lamias_arfs)
...
/mob/living/simple_mob/vore/lamia/arfs/andy/bra
	desc = "Combination snake-human. This one is purple. They're wearing a bra."
	icon_state = "ffta_bra"
	icon_living = "ffta_bra"
	icon_rest = "ffta_bra_rest"
...
// Albino
/mob/living/simple_mob/vore/lamia/arfs/andy/albino
	name = "albino lamia"
	desc = "Combination snake-human. This one is albino."
	icon_state = "albino"
	icon_living = "albino"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/albino/bra
	desc = "Combination snake-human. This one is albino. They're wearing a bra."
	icon_state = "albino_bra"
	icon_living = "albino_bra"
	icon_rest = "albino_bra_rest"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/albino/shirt
	desc = "Combination snake-human. This one is albino. They're wearing a shirt."
	icon_state = "albino_shirt"
	icon_living = "albino_shirt"
	icon_rest = "albino_shirt_rest"
...
// Cobra
/mob/living/simple_mob/vore/lamia/arfs/andy/cobra
	name = "cobra lamia"
	desc = "Combination snake-human. This one looks like a cobra."
	icon_state = "cobra"
	icon_living = "cobra"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/cobra/bra
	desc = "Combination snake-human. This one looks like a cobra. They're wearing a bra."
	icon_state = "cobra_bra"
	icon_living = "cobra_bra"
	icon_rest = "cobra_bra_rest"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/cobra/shirt
	desc = "Combination snake-human. This one looks like a cobra. They're wearing a shirt."
	icon_state = "cobra_shirt"
	icon_living = "cobra_shirt"
	icon_rest = "cobra_shirt_rest"
...
// Copper
/mob/living/simple_mob/vore/lamia/arfs/andy/copper
	name = "copper lamia"
	desc = "Combination snake-human. This one is copper."
	icon_state = "copper"
	icon_living = "copper"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/copper/bra
	desc = "Combination snake-human. This one is copper. They're wearing a bra."
	icon_state = "copper_bra"
	icon_living = "copper_bra"
	icon_rest = "copper_bra_rest"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/copper/shirt
	desc = "Combination snake-human. This one is copper. They're wearing a shirt."
	icon_state = "copper_shirt"
	icon_living = "copper_shirt"
	icon_rest = "copper_shirt_rest"
...
// Green
/mob/living/simple_mob/vore/lamia/arfs/andy/green
	name = "green lamia"
	desc = "Combination snake-human. This one is green."
	icon_state = "green"
	icon_living = "green"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/green/bra
	desc = "Combination snake-human. This one is green. They're wearing a bra."
	icon_state = "green_bra"
	icon_living = "green_bra"
	icon_rest = "green_bra_rest"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/green/shirt
	desc = "Combination snake-human. This one is green. They're wearing a shirt."
	icon_state = "green_shirt"
	icon_living = "green_shirt"
	icon_rest = "green_shirt_rest"
...
// Zebra
/mob/living/simple_mob/vore/lamia/arfs/andy/zebra
	name = "zebra lamia"
	desc = "Combination snake-human. This one has a zebra pattern."
	icon_state = "zebra"
	icon_living = "zebra"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/zebra/bra
	desc = "Combination snake-human. This one has a zebra pattern. They're wearing a bra."
	icon_state = "zebra_bra"
	icon_living = "zebra_bra"
	icon_rest = "zebra_bra_rest"
...
/mob/living/simple_mob/vore/lamia/arfs/andy/zebra/shirt
	desc = "Combination snake-human. This one has a zebra pattern. They're wearing a shirt."
	icon_state = "zebra_shirt"
	icon_living = "zebra_shirt"
	icon_rest = "zebra_shirt_rest"
