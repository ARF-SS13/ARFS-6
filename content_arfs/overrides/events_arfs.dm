...
//
// ARFS overrides to the default event manager configuration.
//
...
/datum/event/aurora_caelus/announce()
	...
	ARFS has approved a short break for all employees to relax and observe this very rare event. \
	...
	We hope you enjoy the lights.", "ARFS Meteorology Division", new_sound = 'sound/effects/ding.ogg') //VOREStation Edit
...
"ARFS Meteorology Division", new_sound = 'sound/effects/ding.ogg') //VOREStation Edit
	..()
